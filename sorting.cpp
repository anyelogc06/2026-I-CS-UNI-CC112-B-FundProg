...
void DemoSearch(){
    ...
    cout << "Buscando " << 10 << ": " << BinarySearch(arr1, 0, n1 - 1, 10, Mayor<T1>) << endl;
    cout <<endl;

    T2 arr2[] = {5.2, 7.5, 8.1, 1.9, 8.9, 9.1, 4.4, 7.7, 3.3, 6.6};
    auto n2 = sizeof(arr2) / sizeof(arr2[0]);
    BurbujaClasico(arr2, n2, Mayor<T2>);
    PrintArray(arr2, n2);
    cout << "Buscando " << 5.2 << ": " << BinarySearch(arr2, 0, n2 - 1, 5.2, Mayor<T2>) << endl;
    cout << "Buscando " << 10.2 << ": " << BinarySearch(arr2, 0, n2 - 1, 10.2, Mayor<T2>) << endl;
    cout <<endl;

    string arr3[] = {"Hola", "Mundo", "Adios", "Mundo"};
    auto n3 = sizeof(arr3) / sizeof(arr3[0]);
    BurbujaClasico(arr3, n3, Mayor<string>);
    PrintArray(arr3, n3);
    cout << "Buscando " << "Hola" << ": " << BinarySearch(arr3, 0, n3 - 1, string("Hola"), Mayor<string>) << endl;
    cout << "Buscando " << "Mundo" << ": " << BinarySearch(arr3, 0, n3 - 1, string("Mundo"), Mayor<string>) << endl;
    cout <<endl;
}
